...
def model_forward(netF,netB,netC,netE,netEC, X, y, classes,global_step,annealing_step):
    ...
    loss2=CrossEntropyLabelSmooth(num_classes=args.class_num, epsilon=args.smooth)(output, y) 
...
if __name__ == "__main__":
    ...
    parser.add_argument('--output', type=str, default='ckps/source—mul_evi')
    parser.add_argument('--trte', type=str, default='val', choices=['full', 'val'])
    parser.add_argument('--output_src', type=str, default='ckps/source—mul')
